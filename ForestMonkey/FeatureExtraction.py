...
def loadData(color_mode="HSV", crop_pad=0.25, size_percent=True, save=None, reload=None):
    global Label_, Label
    check_data()
    Label_ = {}
    count = 1
...
def featureExtract(outside="full", distance_threshold=100, shape_detail="full", colour_detail="full", meta_detail=True,
